...
@allure.epic("testing product page")
class ProductPage(BasePage):
    ...
    @allure.step("add item to the basket")
    ...
    @allure.step("check item in basket")
