...
class ProductPage(BasePage):
    ...
    def check_product_name(self, expected_book_name):
        actual_book_name = self.browser.find_element(*locators.ProductPageLocators.BOOK_NAME_IN_CATALOG)
        # time.sleep(15)
    ...
    def check_product_name_in_basket(self, expected_book_name):
        ...
        # expected_message = expected_book_name + " был добавлен в вашу корзину."
    ...
    def should_not_be_success_message(self):
        assert not self.is_element_present(
            *locators.ProductPageLocators.MESSAGE_ABOUT_ADDING), "Success message is presented"

    def elem_should_disappear(self):
        assert self.is_disappeared(
            *locators.ProductPageLocators.MESSAGE_ABOUT_ADDING), "Succes message didn't disappeared in 4 sec"
